...
import com.ishom.jlatexmath.JLatexMathAndroid;
import com.ishom.jlatexmath.awt.Font;
...
public class DefaultTeXFont implements TeXFont {
    ...
    public static void addAlphabet(Character.UnicodeBlock alphabet, String name) {
        String lg = "org/scilab/forge/jlatexmath/fonts/" + name + "/language_" + name+ ".xml";
        String sym = "org/scilab/forge/jlatexmath/fonts/" + name + "/symbols_" + name+ ".xml";
        String map = "org/scilab/forge/jlatexmath/fonts/" + name + "/mappings_" + name+ ".xml";
